...
//        String path = "/root/aiminding/v5/user_prodv5.txt";
        ...
        userIdList.forEach(staffId -> {
            JSONObject req = new JSONObject();
            req.put("staff_id", staffId);
            req.put("name", "agency" + staffId);
            try {
               executorService.submit(() -> createUser(req.toJSONString()));
            } catch (Exception e) {
...
//        BufferedWriter writer = new BufferedWriter(new FileWriter("/root/aiminding/v5/failedUserId.txt"));
